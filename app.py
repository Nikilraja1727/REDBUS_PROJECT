...
def get_connection():
    return pymysql.connect(host = "localhost",user = "root",password = "Amma@1727",database='redbus')
...
def home_page():
    ...
    st.image(r"/Users/nikilraja/Downloads/Guvi study material/redbus image.jpg")
...
def about_page():
    ...
    st.write("""
        This app is Designed by Nikil. I am from Coimbatore, Tamil Nadu. I have completed my Undergraduate from Sri Krishna College of Arts and Science in Bachelors of Commerce. I have been working at a Data Analysis company called NielsenIQ in Chennai since July,2023.
    """)
    st.image(r"/Users/nikilraja/Library/Mobile Documents/com~apple~CloudDocs/f0374688-3cfd-4429-803d-fde4dbae759f.JPG")
